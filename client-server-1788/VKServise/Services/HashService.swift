...
//        татическое свойство, имя папки, в которой будут сохраняться изображения. Свойство инициируется с помощью замыкания. Помимо этого, в замыкании происходит проверка, существует ли папка. Если не существует, она будет создана.
        let pathName = "images"
